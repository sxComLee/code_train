 ...
 *
 */
public class EdwEncrypt extends UDF {

  //String appId = "4119c541aa55";
  public EdwEncrypt() {
  }
  ...
  public String evaluate(String value) {
    ...
    String encryptResult = es.encrypt(appId, null, value);
    return  encryptResult;
  }
  public String evaluate(String value, String salt) {
    Encryption es = EncryptionSingleton.getInstance();
    String appId = es.getSlefAPPID();
    String encryptData = es.encrypt(appId, salt, value);
    return encryptData;
  }
}
