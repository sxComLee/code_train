...
public class HbaseClient {
    ...
    static {
        ...
        conf.set("hbase.rootdir", tool.get("hbase.rootdir"));
        conf.set("hbase.zookeeper.quorum", tool.get("hbase.zookeeper.quorum"));
        conf.set("hbase.client.scanner.timeout.period", tool.get("hbase.client.scanner.timeout.period"));
        conf.set("hbase.rpc.timeout", tool.get("hbase.rpc.timeout"));
        try {
    ...
    public static void createTable(String tableName, String... columnFamilies) throws IOException {
        ...
        if(admin.tableExists(tablename)){
            ...
            for (String columnFamliy : columnFamilies) {
                tableDescriptor.addFamily(new HColumnDescriptor(columnFamliy));
            }
