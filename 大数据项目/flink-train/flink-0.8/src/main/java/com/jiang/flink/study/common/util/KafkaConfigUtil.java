...
import com.jiang.flink.study.common.schemas.MetricSchema;
...
public class KafkaConfigUtil {
     ...
     * @return
     */
    public static Properties buildKafkaProps(ParameterTool parameterTool,String groupId) {
    ...
    public static DataStreamSource<MetricEvent> buildSource(StreamExecutionEnvironment env, String topic, Long time) throws IllegalAccessException {
        ...
        FlinkKafkaConsumer<MetricEvent> consumer = new FlinkKafkaConsumer<MetricEvent>(
                topic,
                new MetricSchema(),
                props);
