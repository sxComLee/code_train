    ...
    private static class HBaseOutputFormat implements OutputFormat<String> {
        ...
        public void open(int taskNumber, int numTasks) throws IOException {
            ...
            if (!admin.tableExists(tableName)) { //检查是否有该表，如果没有，创建
                ...
                HTableDescriptor hTableDescriptor = new HTableDescriptor(TableName.valueOf(ExecutionEnvUtil.PARAMETER_TOOL.get(HBASE_TABLE_NAME)));
                hTableDescriptor.addFamily(new HColumnDescriptor(ExecutionEnvUtil.PARAMETER_TOOL.get(HBASE_COLUMN_NAME)));
