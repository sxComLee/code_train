...
public class TumblingEventTimeWindows extends WindowAssigner<Object, TimeWindow> {
     ...
     *
     * @param size The size of the generated windows.
     * @param offset The offset which window start would be shifted by. 窗口开始移动的时间
     */
     ...
     *
     * @param size The size of the generated windows. 滚动窗口长度
     * @param offset The globalOffset which window start would be shifted by. 指定窗口开始时间
