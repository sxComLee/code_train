...
public class ProduceResponse extends AbstractResponse {
        ...
        responses.forEach((tp, response) -> {
            ...
            tpr.partitionResponses()
                    .add(new ProduceResponseData.PartitionProduceResponse().setIndex(tp.partition())
                            ...
                            .setRecordErrors(response.recordErrors.stream()
                                    .map(e -> new ProduceResponseData.BatchIndexAndErrorMessage().setBatchIndex(e.batchIndex)
    ...
    public Map<Errors, Integer> errorCounts() {
        ...
        data.responses()
                .forEach(t -> t.partitionResponses()
                        .forEach(p -> updateErrorCounts(errorCounts, Errors.forCode(p.errorCode()))));
        return errorCounts;
    }
    ...
    public static final class PartitionResponse {
        ...
        public PartitionResponse(Errors error, long baseOffset, long logAppendTime, long logStartOffset,
                                 List<RecordError> recordErrors, String errorMessage) {
            this.error = error;
        ...
        public boolean equals(Object o) {
            ...
            return baseOffset == that.baseOffset && logAppendTime == that.logAppendTime && logStartOffset == that.logStartOffset && error == that.error && Objects.equals(
                    recordErrors, that.recordErrors) && Objects.equals(errorMessage, that.errorMessage);
        }
