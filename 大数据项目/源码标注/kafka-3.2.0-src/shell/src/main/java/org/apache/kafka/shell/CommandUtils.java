...
public final class CommandUtils {
     ...
     * @param candidates        The list to add the output completions to.
     */
    public static void completePath(MetadataNodeManager nodeManager, String pathPrefix,
        ...
        nodeManager.visit(data -> {
            ...
            Entry<String, MetadataNode> candidate = directory.children()
                    .ceilingEntry(lastComponent);
            ...
            while (candidate != null && candidate.getKey()
                    .startsWith(lastComponent)) {
                StringBuilder candidateBuilder = new StringBuilder();
                candidateBuilder.append(effectivePrefix)
                ...
                candidates.add(
                        new Candidate(candidateBuilder.toString(), candidateBuilder.toString(), null, null, null, null, complete));
                candidate = directory.children()
                        .higherEntry(candidate.getKey());
            }
        });
    }
}
