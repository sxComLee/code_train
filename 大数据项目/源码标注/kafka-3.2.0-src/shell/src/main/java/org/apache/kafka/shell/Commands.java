...
public final class Commands {
    ...
    static {
        ...
        for (Type type : Arrays.asList(CatCommandHandler.TYPE, CdCommandHandler.TYPE, ExitCommandHandler.TYPE,
                FindCommandHandler.TYPE, HelpCommandHandler.TYPE, HistoryCommandHandler.TYPE, LsCommandHandler.TYPE,
                ManCommandHandler.TYPE, PwdCommandHandler.TYPE)) {
    ...
    public interface Handler {
        void run(Optional<InteractiveShell> shell, PrintWriter writer, MetadataNodeManager manager) throws Exception;
    }
    ...
    public interface Type {
        ...
        void completeNext(MetadataNodeManager nodeManager, List<String> nextWords, List<Candidate> candidates) throws Exception;
    }
    ...
    public Handler parseCommand(List<String> arguments) {
        ...
        if (!command.equals(trimmedArguments.get(0))) {
            return new ErroneousCommandHandler(
                    "invalid choice: '" + trimmedArguments.get(0) + "': did you mean '" + command + "'?");
        }
