...
class KafkaRequestHandler(id: Int,
    ...
    def run(): Unit = {
        while (!stopped) {
             ...
             *  注释： 从 RequestChannel 中获取 Request 请求
             */
            ...
            req match {
                ...
                // TODO_MA 马中华 注释：  如果是正儿八经的请求，则调用：ApiRequestHandler 来处理
                case request: RequestChannel.Request =>
                    try {
                        ...
                        /**
                         * TODO_MA 马中华 https://blog.csdn.net/zhongqi2513
                         *  注释： 通过 ApiRequestHandler 来处理请求
                         *  该请求有两种类型：
                         *  1、ControllerApis 处理来自 Controller 的请求
                         *  2、KafkaApis 处理来自客户端的请求
                         */
...
class KafkaRequestHandlerPool(val brokerId: Int,
    ...
    // TODO_MA 马中华 注释： 创建和启动 KafkaRequestHandler 线程的具体实现
