...
object BrokerIdZNode {
    ...
    // TODO_MA 马中华 注释： ${BrokerIdsZNode.path} = /brokers/ids
    // TODO_MA 马中华 注释： 返回值： /brokers/ids/brokerid
    ...
    def encode(version: Int, host: String, port: Int, advertisedEndpoints: Seq[EndPoint], jmxPort: Int,
        rack: Option[String], features: Features[SupportedVersionRange]
    ): Array[Byte] = {
...
object TopicZNode {
    ...
    // TODO_MA 马中华 注释： /brokers/topics/topic
...
object TopicPartitionsZNode {
    ...
    // TODO_MA 马中华 注释： /brokers/topics/topic/partitions
    def path(topic: String) = s"${TopicZNode.path(topic)}/partitions"
}

object TopicPartitionZNode {

    // TODO_MA 马中华 注释： /brokers/topics/topic/partitions/partition
...
object TopicPartitionStateZNode {
    ...
    // TODO_MA 马中华 注释： /brokers/topics/topic/partitions/partition/state
...
object ZkData {
    ...
    /**
     * TODO_MA 马中华 https://blog.csdn.net/zhongqi2513
     *  注释： Kafka 在 ZooKeeper 上的 ZNode 布局
     *  val PersistentZkPaths = seq ++ seq
     */
