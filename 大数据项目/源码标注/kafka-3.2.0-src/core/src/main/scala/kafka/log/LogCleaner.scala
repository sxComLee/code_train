...
class LogCleaner(initialConfig: CleanerConfig,
     ...
     *  注释： LogCleanerManager 主要负责管理 Log 的压缩状态 + Cleaner Checkpoint 信息维护和更新
     */
    ...
    /**
     * TODO_MA 马中华 https://blog.csdn.net/zhongqi2513
     *  注释： LogCleaner 内部是由一组 CleanerThread 来完成具体工作的
     *  CleanerThread 调用 Cleaner 来完成日志压缩的工作
     */
    ...
    def startup(): Unit = {
        ...
        /**
         * TODO_MA 马中华 https://blog.csdn.net/zhongqi2513
         *  注释： 启动 numThreads 个 Thread 用来完成，Log Clean 的工作。
         */
    ...
    private[log] class CleanerThread(threadId: Int)
        ...
        // TODO_MA 马中华 注释： 真正干活的组件
        // TODO_MA 马中华 注释： 执行日志压缩
        ...
        private def cleanFilthiestLog(): Boolean = {
            ...
            /**
             * TODO_MA 马中华 https://blog.csdn.net/zhongqi2513
             *  注释： 通过 LogCleanerManager 获取需要执行日志压缩的 Log
             */
...
private[log] class Cleaner(val id: Int,
    ...
    private[log] def doClean(cleanable: LogToClean, currentTime: Long): (Long, CleanerStats) = {
        ...
        // TODO_MA 马中华 注释： 注意： 由于 active LogSegment 不参与压缩， 所有 acitve LogSegment 的 baseOffset 就是日志压缩的最大值
        ...
        /**
         * TODO_MA 马中华 https://blog.csdn.net/zhongqi2513
         *  注释： 构建 OffsetMap，获取日志压缩的 offset 上限
         */
        ...
        // TODO_MA 马中华 注释： 获取可以安全删除的 LogSegment
        ...
        // TODO_MA 马中华 注释： 对要进行日志压缩的 日志进行分组。然后按组进行日志压缩
    ...
    private[log] def cleanSegments(log: UnifiedLog,
        ...
        try {
            ...
            // TODO_MA 马中华 注释： flush
            // flush new segment to disk before swap
            cleaned.flush()

            // TODO_MA 马中华 注释： 更新最后的修改时间
             ...
             * TODO_MA 马中华 https://blog.csdn.net/zhongqi2513
             *  注释： 事情比较多：
             *  1、将文件后缀名从 .clean 改成 .swap
             *  2、将 cleaned 对象加入到 segments 跳表中管理
             *  3、将分组中的 LogSegment 从 segments 跳表中删除
             *  4、讲 .swap 文件删除
             */
