...
class ControllerContext {
    ...
    // TODO_MA 马中华 注释： 用来存储 Partition 的 replica 分布的集合
    ...
    def replicasForTopic(topic: String): Set[PartitionAndReplica] = {
        ...
        // TODO_MA 马中华 注释： 从 partitionAssignments 查询
    ...
    private def updatePreferredReplicaImbalanceMetric(partition: TopicPartition,
        ...
        newLeadershipInfo: Option[LeaderIsrAndControllerEpoch]
    ): Unit = {
