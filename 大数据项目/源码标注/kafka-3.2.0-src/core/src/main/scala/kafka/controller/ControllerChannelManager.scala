...
class ControllerChannelManager(controllerContext: ControllerContext,
     ...
     *  注释： 注册登记集合
     *  每一个存活的 Broker ，都会生成一个对应的 ControllerBrokerStateInfo 注册到该集合
     */
    ...
    /**
     * TODO_MA 马中华 https://blog.csdn.net/zhongqi2513
     *  注释： ControllerChannelManager 启动
     */
    def startup() = {

        // TODO_MA 马中华 注释： 完成 Broker（ControllerBrokerStateInfo） 到 brokerStateInfo 的注册
        // TODO_MA 马中华 注释： 生成 ControllerBrokerStateInfo 的时候，会构造一个 RequestSendThread 线程
        controllerContext.liveOrShuttingDownBrokers.foreach(addNewBroker)

        /**
         * TODO_MA 马中华 https://blog.csdn.net/zhongqi2513
         *  注释： 启动到 ControllerChannelManager 中注册成功的 Broker 对应的 RequestSendThread
         *  启动 RequestSendThread
         */
        brokerLock synchronized {
    ...
    private def addNewBroker(broker: Broker): Unit = {
        ...
        /**
         * TODO_MA 马中华 https://blog.csdn.net/zhongqi2513
         *  注释： Controller 和 Broker 通信的工作线程
         */
        ...
        /**
         * TODO_MA 马中华 https://blog.csdn.net/zhongqi2513
         *  注释： 完成 Broker 到 Controller 的 brokerStateInfo 的注册
         */
    ...
    protected def startRequestSendThread(brokerId: Int): Unit = {
        ...
        // TODO_MA 马中华 注释： 每个 Broker 都对应到一个 RequestSendThread
        val requestThread = brokerStateInfo(brokerId).requestSendThread

        // TODO_MA 马中华 注释： 启动线程 RequestSendThread
    ...
    override def doWork(): Unit = {
        ...
        try {
            ...
            while (isRunning && !isSendSuccessful) {
                ...
                try {
                    // TODO_MA 马中华 注释： 等待和 Broker 建立连接
                    if (!brokerReady()) {
                        isSendSuccessful = false
                        backoff()
                    }
                    else {
                        // TODO_MA 马中华 注释： 构建请求对象 ClientRequest , 然后发送
