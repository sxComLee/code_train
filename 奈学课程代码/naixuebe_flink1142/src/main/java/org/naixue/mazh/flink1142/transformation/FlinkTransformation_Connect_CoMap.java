package org.naixue.mazh.flink1142.transformation;
...
public class FlinkTransformation_Connect_CoMap {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStreamSource<Long> text1 = executionEnvironment.addSource(new UserDefineSource_NoParallel(1, 1000)).setParallelism(1);

        // TODO_MA 马中华 注释：
        // TODO_MA 马中华 注释： strDS = (str_1, str_2, str_3)
        DataStreamSource<Long> text2 = executionEnvironment.addSource(new UserDefineSource_NoParallel(1000, 3000))
                .setParallelism(1);
    ...
    public static class UserDefineSource_NoParallel implements SourceFunction<Long> {
        ...
        public UserDefineSource_NoParallel(long start, long sleepTime) {
            this.number = start;
