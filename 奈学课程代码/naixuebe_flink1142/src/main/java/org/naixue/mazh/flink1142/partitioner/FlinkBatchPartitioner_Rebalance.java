...
public class FlinkBatchPartitioner_Rebalance {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // TODO_MA 马中华 注释： 重新平衡。解决数据倾斜，采用 Round-Robin（轮询） 的方式
        // TODO_MA 马中华 注释： DataSet 均匀分布在 下游的所有 Task
         ...
         */
        resultDS.writeAsText("file:///C:\\bigdata-data\\flink_batch_reblance\\result1142");
        // TODO_MA 马中华 注释： 如果最终输出的就是一个文件，那么你指定的  result1142 就是一个文件
        // TODO_MA 马中华 注释： 如果最终输出的不是一个文件，那么你指定的  result1142 就是一个文件夹
