 ...
 *  测试的时候，运行：nc -lk 6789
 */
public class StreamingWordCount_Object {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<WordAndCount> wordAndOneDS = sourceDataStream.flatMap(
        ...
        // TODO_MA 马中华 注释： 分组聚合
        SingleOutputStreamOperator<WordAndCount> resultDS = wordAndOneDS.keyBy("word").sum("count");
